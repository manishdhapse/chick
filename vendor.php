...
if (isset($_GET['remove'])) {
  ...
  $removeUser = $vendor->deleteUserById($remove);
}
 ...
 ?>
      <div class="card ">
        <div class="card-header">
          <h3><i class="fas fa-users mr-2"></i>Vendor list 
            <a type="button"  href="addVendor.php" class="btn btn-secondary btn-sm">Add Vendor</a>
          ...
          <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                  ...
                  <tbody>
                    <?php
                      ...
                      $allUser = $vendor->selectAllVendorData();
